    ...
    <div className="grid grid-cols-1 gap-3">
      <div className="flex bg-white shadow-lg overflow-hidden rounded mb-3 group">
        ...
        <div className="ml-4 mt-6">
          ...
          <div className="flex space-x-3">
            <a
              href="/#"
              className="bg-myColor text-white border border-myColor px-7 py-2 hover:bg-transparent hover:text-myColor rounded-md font-medium"
            >
            ...
            <a
              href="/#"
              className="bg-white text-myColor border border-myColor px-10  py-2 hover:bg-myColor hover:text-white rounded-md font-medium"
            >
      ...
      <div className="flex bg-white shadow-lg rounded overflow-hidden mb-3 group">
        <div className="relative">
          <div className="flex justify-center center h-72 bg-gray-100">
            <img
              src={shoes}
              className="object-contain pt-12 h-56 w-80 "
              alt=""
            />
          </div>
          <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
        ...
        <div className="ml-4 mt-6">
          ...
          <div className="flex items-baseline mb-1 space-x-2">
            <p className="text-myColor font-medium">$60.00</p>
      ...
      <div className="flex bg-white shadow-lg rounded overflow-hidden group">
        ...
        <div className="ml-4 mt-6">
          ...
          <div className="flex items-baseline mb-1 space-x-2">
            <p className="text-myColor font-medium">$70.00</p>
