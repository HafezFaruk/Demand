  ...
  return (
    <div className="grid grid-cols-3 gap-6">
      <div className="bg-white shadow-lg rounded overflow-hidden group">
        ...
        <a
          href="/#"
          className="mt-10 py-1 w-full text-center hidden group-hover:block text-white bg-myColor border border-myColor rounded-b hover:bg-transparent hover:text-myColor transition-all"
        >
          add to card
        </a>
      </div>
      <div className="bg-white shadow-lg rounded overflow-hidden group">
        <div className="relative">
          <div className="flex justify-center h-52 bg-gray-100">
            <img src={shoes} className="object-contain pt-5 h-44 w-48" alt="" />
          </div>
          <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
            <a
              href="/#"
      ...
      <div className="bg-white shadow-lg rounded overflow-hidden group">
        ...
        <div className="pt-3 pb-3 px-4">
          ...
          <div className="group-hover:hidden">
            ...
            <div className="flex items-baseline mb-1 space-x-2">
              <p className="text-xl text-myColor font-semibold">$50.00</p>
              <p className="text-sm text-gray-400 line-through">$55.00</p>
            </div>
            <div className="flex items-center">
              <div className="flex gap-1 text-sm text-yellow-400">
