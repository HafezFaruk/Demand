                  ...
                  <div className="flex justify-between mt-5 border-gray-300 rounded-md shadow-lg border-2 ">
                    <div className="flex items-center">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-myColor font-medium ">$45.00</p>
                        <p>Size : M</p>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <div>
                        <div className="flex space-x-16 mr-10">
                          ...
                          <p className="text-2xl pt-1 text-myColor">$45.00</p>
                          <div className="pt-2">
              ...
              <div className="flex mt-5 justify-between border-gray-300 rounded-md shadow-lg border-2 ">
                <div className="flex items-center">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-myColor font-medium ">$499.00</p>
                    <p>Size : M</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <div>
                    <div className="flex space-x-16 mr-10">
                      ...
                      <p className="text-2xl pt-1 text-myColor">$499.00</p>
                      <div className="pt-2">
                        <i class="fa-solid fa-trash-can"></i>
                      </div>
                    </div>
        ...
        <div className="col-span-3">
          <div className="border-gray-400 border p-5 rounded-md">
            ...
            <div className="flex px-1 pt-5">
              <input
                className="form-control w-44 rounded-l-md focus:outline-none focus:ring-1 focus:ring-myColor"
                type="number"
                name=""
                placeholder="Enter Coupon"
                id=""
              />
              <button className="border-myColor rounded-r-md text-white bg-myColor hover:bg-transparent hover:text-myColor border px-2">
                APPLY
              </button>
            </div>
            <button className="border border-myColor mt-8 mb-3 py-2 px-7 text-white bg-myColor hover:bg-transparent hover:text-myColor font-bold rounded-md ">
              Process To Checkout
            </button>
          </div>
        </div>
