...
const Timeline = () => {
    return (
      <div>
        <div className="flex items-center mt-10 mx-10">
        ...
        <div className="mx-14">
          <div>
            <h1 className="font-medium text-2xl mt-14">ORDER TRACKING</h1>
          </div>
          <div className="mt-4">
            <label htmlFor="">Order ID *</label> <br />
            <input
              className="w-1/3 mt-1 focus:outline-none rounded-md py-2 px-2 border-2 border-myColor"
              type="search"
              name=""
              placeholder="search"
              id=""
          ...
          <button className="bg-myColor hover:bg-myColor uppercase text-white font-semibold py-3 px-10 my-8 border-none rounded-md">
            TRACK ORDER
          </button>
