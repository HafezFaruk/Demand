        ...
        <div className="px-5 py-5 w-5/12 bg-white shadow-lg border rounded-md">
          ...
          <div className="">
            <form>
              ...
              <div className="flex items-start mt-5 mb-6">
                ...
                <div className="ml-3 text-sm">
                  <label htmlfor="terms" className="font-medium text-gray-500 ">
                    I agree with the{" "}
                    <a href="/#" className="text-myColor hover:underline ">
              ...
              <button
                type="submit"
                className="text-white w-full border border-myColor bg-myColor hover:bg-transparent hover:text-myColor focus:ring-4 focus:ring-myColor font-medium rounded-md text-sm px-5 py-2.5 text-center "
              >
          ...
          <p className="text-center mt-5">Already have an account.? <Link className="text-myColor font-medium" to="/login">Login Now</Link></p>
        </div>
      </div>
    </div>
  );
