          ...
          <div className="shadow-lg rounded-md px-5 py-5 border">
            ...
            <div className="w-60">
              ...
              <div className="flex justify-between pt-1">
                <p className="text-myColor font-medium">EMBOSSED</p>
                <p>8973ER3463</p>
              </div>
            </div>
              ...
              <div className="flex justify-between w-full items-center">
                ...
                <div className="">
                  <label className="text-sm text-gray-500" htmlFor="">
                    Select A Reason <span className="text-myColor">*</span>
                    <br />
                    <select className="rounded-md focus:outline-none focus:ring-0 focus:ring-myColor">
            ...
            <div className="">
              ...
              <div className="flex space-x-2.5">
                <input className="ml-1.5 mt-1 focus:outline-none focus:ring-0 text-none focus:text-myColor cursor-pointer border border-myColor" type="radio" name="" id="" />
                <div>
              ...
              <div className="">
                <form>
                  ...
                  <input
                    type="radio"
                    id="html"
                    className="focus:outline-none focus:ring-0 text-none focus:text-myColor cursor-pointer border border-myColor"
                    name="fav_language"
                    value="HTML"
                  />
                  ...
                  <input
                    type="radio"
                    id="css"
                    className="focus:outline-none focus:ring-0 focus:text-myColor cursor-pointer border border-myColor"
                    name="fav_language"
                    value="CSS"
                  />
