    ...
    <div>
      ...
      <div id="accordion-collapse" data-accordion="collapse">
        <h2 id="accordion-collapse-heading-1">
          <button
            type="button"
            class="flex justify-between items-center p-5 w-full font-medium text-left border border-b-0  dark:border-gray-700 "
        ...
        >
          <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 ">
            <p class="mb-2 text-gray-900 dark:text-gray-900">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Voluptates ut, culpa vel tenetur nesciunt officiis iure
              repudiandae voluptate voluptatum. Voluptate obcaecati aperiam,
              ducimus praesentium doloremque veritatis quia aut debitis veniam.
            </p>
