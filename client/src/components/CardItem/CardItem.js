        ...
        <div className="grid grid-cols-4 gap-6">
          <div className="bg-white shadow rounded overflow-hidden group">
            <div className="relative">
              <img
                src="http://rafcart.rslahmed.com/assets/images/product9.jpg"
                className="w-full"
                alt=""
              />
          ...
          <div className="bg-white shadow rounded overflow-hidden group">
            <div className="relative">
              <img
                src="http://rafcart.rslahmed.com/assets/images/product1.jpg"
                className="w-full"
                alt=""
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
          ...
          <div className="bg-white shadow rounded overflow-hidden group">
            <div className="relative">
              <img
                src="http://rafcart.rslahmed.com/assets/images/product12.jpg"
                className="w-full"
                alt=""
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
          ...
          <div className="bg-white shadow rounded overflow-hidden group">
            <div className="relative">
              <img
                src="http://rafcart.rslahmed.com/assets/images/product8.jpg"
                className="w-full"
                alt=""
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
